...
///
/// {@endtemplate}
Widget getMaterialVideoControls(VideoState state) {
...
class MaterialVideoControlsThemeData {
  ...
  const MaterialVideoControlsThemeData({
    ...
    this.seekBarMargin = const EdgeInsets.only(
      left: 16.0,
      right: 16.0,
      bottom: 52.0,
    ),
                  ...
                  Column(
                    children: [
                      ...
                      Stack(
                        ...
                        children: [
                          if (_theme(context).displaySeekBar)
                            MaterialSeekBar(delta: _seekBarDeltaValueNotifier),
                          Container(
                            height: _theme(context).buttonBarHeight,
                            margin: _theme(context).bottomButtonBarMargin,
                          ),
                    ...
                    Positioned(
                      left: tapped
                          ...
                          : (constraints.maxWidth -
                                ...
                                positionPercent,
                      bottom:
                          -1.0 * _theme(context).seekBarThumbSize / 2 +
